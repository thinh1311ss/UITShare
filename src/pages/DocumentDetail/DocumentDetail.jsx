...
import {ArrowLeft,Star,Copy,ExternalLink,ShoppingCart,User,FileText,} from "lucide-react";
  ...
  return (
    <section className="relative py-12 text-white px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-6">
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-gray-500 text-sm">({doc.reviews.toLocaleString()} đánh giá)</span>
              </div>
            ...
            <div>
              <h3 className="text-lg font-bold text-white mb-4">
                Đánh giá <span className="text-gray-500 font-normal text-sm">({doc.reviews.toLocaleString()})</span>
              </h3>
        ...
        {/*Related*/}
        <div className="mt-16">
          <p className="text-cyan-400 text-sm font-semibold mb-2">✦ Có thể bạn thích</p>
          <h2 className="text-3xl md:text-4xl font-bold mb-12">Tài liệu liên quan</h2>
