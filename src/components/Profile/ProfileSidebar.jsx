import { FiUser, FiFileText, FiCreditCard, FiClock, FiStar, FiLogOut, FiGift } from "react-icons/fi";
    ...
    <div className="flex flex-col h-full bg-white/5 backdrop-blur-md px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/10">
        ...
        <div className="flex flex-col overflow-hidden">
          <span className="text-sm font-semibold text-white truncate">Trần Thành Vinh</span>
          <span className="text-xs text-gray-400 truncate">tranthanhvinh@gmail.com</span>
        </div>
      </div>
